...
% ================================================================================
% Generated on: 09/25/2019 15:16:01
...
mode_mapping = [0,1,2,3];
  coef_in_file = fopen ('filter_core_coef_reload.txt', 'r');
...
for j = 1:sx
    ...
    %
    file_name = ['filter_core_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = filter_core_mlab(single_channel_data{i}, single_channel_bank{i}, h);
  ...
  for j = 1: limit;
    ...
    file_name = ['filter_core_model_output'];
